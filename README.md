# `NEO_jll.jl` (v22.53.25242+0)

[![deps](https://juliahub.com/docs/NEO_jll/deps.svg)](https://juliahub.com/ui/Packages/NEO_jll/LbB4W?page=2)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/f78fcd4d56b6c83369c7bbe05e845dc74c51ea00/N/NEO/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://github.com/intel/compute-runtime.git (revision: `d9a4eeea8900fa32a45212cdc72293592295159f`)
